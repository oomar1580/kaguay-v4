...
function buildAPI(globalOptions, html, jar) {
  ...
  if (maybeUser.length === 0 && maybeTiktik.length === 0) {
      return console.log("No cookie found for user, please check login information again", 'error');
  } else {
      if (html.indexOf("/checkpoint/block/?next") > -1) {
           return console.log("Appstate dead, please replace with a new one!", 'error');
      }
...
/// Bằng cách nào đó tắt Online sẽ đánh lừa đc Fb 
    var globalOptions = {
        ...
        online: false,
        emitReady: false,
        userAgent: "Mozilla/5.0 (Linux; Android 9; SM-G973U Build/PPR1.180610.011) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Mobile Safari/537.36" //Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_2) AppleWebKit/600.3.18 (KHTML, like Gecko) Version/8.0.3 Safari/600.3.18
    };
